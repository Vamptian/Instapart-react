    ...
    const renderSignInOutButtons = () => {
        if (props.user.email === undefined){
            ...
            <div class="dropdown tile flex-col ">
             <span className='fill center'>ACCOUNT</span>
            ...
            <div class="dropdown tile flex-col ">
             <span className='fill center'>ACCOUNT</span>
                <div class="dropdown-content">
                    <p><li className='dropdown-buttons'><a href="/User-Page">View Profile</a></li></p>
    ...
    <div className='flex-row background-teal header-main fill-header'>
        ...
        <div className='flex-row two-third-width inline center'>
            <div class="dropdown  flex-col ">
             <span className='fill tile center'>BROWSE</span>
                <div class="dropdown-content">
                <p><li className='dropdown-buttons'><a href="/All-parts">Show Parts</a></li></p>
                    <p><li className='dropdown-buttons'><a href="/All-post">Show Posts</a></li></p>
                </div>
            </div>
            ...
            <div class="dropdown tile flex-col ">
             <span className='fill center'>CONTACT US</span>
                <div class="dropdown-content">
                    ...
                    <p><button className='dropdown-buttons'>Contact Us</button></p>
                </div>
            </div>
        </div>
    </div>
